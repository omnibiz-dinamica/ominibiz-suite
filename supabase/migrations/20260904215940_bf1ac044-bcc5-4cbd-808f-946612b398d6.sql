-- Repara o feed operacional: um período de férias é um único evento de gestão.
-- Nunca expande férias históricas em milhares de dias e nunca cria time_entries.
