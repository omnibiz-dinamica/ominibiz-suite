-- SUP-2026-000145
-- A recurring task is materialized once per recurrence/occurrence. Preserve
-- the creation batch so multi-employee recurring tasks keep the same group
-- semantics as one-off multi-employee tasks.
