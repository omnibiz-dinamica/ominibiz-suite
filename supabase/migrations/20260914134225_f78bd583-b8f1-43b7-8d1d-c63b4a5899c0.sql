-- 1) Limpar referências órfãs antes de criar o vínculo formal
...
ALTER TABLE public.task_recurrences
  DROP CONSTRAINT IF EXISTS task_recurrences_client_id_fkey;

ALTER TABLE public.task_recurrences
  ADD CONSTRAINT task_recurrences_client_id_fkey
  FOREIGN KEY (client_id) REFERENCES public.clients(id) ON DELETE SET NULL;

-- 2) Materialização resiliente: falha em uma série não aborta a empresa inteira
