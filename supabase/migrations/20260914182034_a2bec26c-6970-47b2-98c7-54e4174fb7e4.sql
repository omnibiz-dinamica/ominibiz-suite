  ...
  LOOP
    BEGIN
      ...
      LOOP
        ...
        -- protecao canonica. Nao materializar novamente a mesma tarefa viva,
        -- mas preservar tarefas legitimas com titulos diferentes.
        IF NOT EXISTS (
          SELECT 1
          ...
          VALUES (
            ...
            v_rec.punch_mode_override, v_rec.id, v_day, v_rec.task_group_id
          )
