-- Corrige o encerramento do ponto quando uma instalação ainda possui a
-- implementação antiga do helper de geolocalização.
-- Apenas reforça valores derivados; não altera dados, RLS ou permissões.
...
BEGIN
  ...
  -- reason_code is NOT NULL in time_entry_geopoints. Older deployments could
  -- reach this helper with a null reason during stop.
